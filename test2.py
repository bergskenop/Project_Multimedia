...
# PYTHON SCRIPT OM GEPASTE PARAMETERS VOOR HET VINDEN VAN DE HOEKEN TE PROBEREN88!!
...
# if image.shape[0] < 400 and image.shape[2] < 400:
...
corners = cv2.goodFeaturesToTrack(thresh, maxCorners=rijen*kolommen*4, qualityLevel=0.5, minDistance=40, blockSize=7,
                                  useHarrisDetector=True, k=0.21)
