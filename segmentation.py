...
def getCorrectPuzzleSize(puzzle):
    hoogte = abs(puzzle.puzzle_pieces[0].corners[0][1] - puzzle.puzzle_pieces[0].corners[1][1])
    breedte = abs(puzzle.puzzle_pieces[0].corners[1][0] - puzzle.puzzle_pieces[0].corners[2][0])
